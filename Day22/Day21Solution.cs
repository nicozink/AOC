...
namespace Solutions
{
    ...
    public class Day22Solution
    {
        ...
        public static long SolveExample1() => CountCubes("Day22/Example1.txt", initialiseOnly: true);

        public static long SolveExample2() => CountCubes("Day22/Example2.txt", initialiseOnly: true);

        [SolutionMethod(Part = 1)]
        public static long SolvePart1() => CountCubes("Day22/Input.txt", initialiseOnly: true);

        public static long SolveExample3() => CountCubes("Day22/Example3.txt", initialiseOnly: true);

        public static long SolveExample4() => CountCubes("Day22/Example3.txt", initialiseOnly: false);

        [SolutionMethod(Part = 2)]
        public static long SolvePart2() => CountCubes("Day22/Input.txt", initialiseOnly: false);
