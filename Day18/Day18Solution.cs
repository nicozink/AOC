...
namespace Solutions
{
    ...
    public class Day18Solution
    {
        ...
        public static long SolveExample1() => GetMagnitudeSum("Day18/Example.txt");

        [SolutionMethod(Part = 1)]
        public static long SolvePart1() => GetMagnitudeSum("Day18/Input.txt");

        public static long SolveExample2() => GetMaxMagnitudeCombo("Day18/Example.txt");

        [SolutionMethod(Part = 2)]
        public static long SolvePart2() => GetMaxMagnitudeCombo("Day18/Input.txt");
