...
namespace Solutions
{
    ...
    public class Day11Solution
    {
        ...
        public long SolveExample1() => CountFlashes("Day11/Example.txt");

        [SolutionMethod(Part = 1)]
        public long SolvePart1() => CountFlashes("Day11/Input.txt");

        public long SolveExample2() => CountSteps("Day11/Example.txt");

        [SolutionMethod(Part = 2)]
        public long SolvePart2() => CountSteps("Day11/Input.txt");
