...
namespace Solutions
{
    ...
    public class Day08Solution
    {
        ...
        public long SolveExample1() => CountEasyNumbers("Day08/Example.txt");

        [SolutionMethod(Part = 1)]
        public long SolvePart1() => CountEasyNumbers("Day08/Input.txt");

        public long SolveExample2() => AddNumbers("Day08/Example.txt");

        [SolutionMethod(Part = 2)]
        public long SolvePart2() => AddNumbers("Day08/Input.txt");
