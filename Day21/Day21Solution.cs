...
namespace Solutions
{
    ...
    public class Day21Solution
    {
        ...
        public static int SolveExample1() => PlayDeterministicDice(4, 8);
            
        [SolutionMethod(Part = 1)]
        public static int SolvePart1() => PlayDeterministicDice(4, 5);

        public static long SolveExample2() => PlayDiracDice(4, 8);

        [SolutionMethod(Part = 2)]
        public static long SolvePart2() => PlayDiracDice(4, 5);
