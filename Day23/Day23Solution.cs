...
namespace Solutions
{
    ...
    public class Day23Solution
    {
        ...
        public static int SolveExample1() => FindLeastEnergy("Day23/Example1.txt");

        [SolutionMethod(Part = 1)]
        public static int SolvePart1() => FindLeastEnergy("Day23/Input1.txt");

        public static int SolveExample2() => FindLeastEnergy("Day23/Example2.txt");

        [SolutionMethod(Part = 2)]
        public static int SolvePart2() => FindLeastEnergy("Day23/Input2.txt");
