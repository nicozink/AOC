...
namespace Solutions
{
    ...
    public class Day09Solution
    {
        ...
        public long SolveExample1() => SumLowPoints("Day09/Example.txt");

        [SolutionMethod(Part = 1)]
        public long SolvePart1() => SumLowPoints("Day09/Input.txt");

        public long SolveExample2() => MultiplyBasins("Day09/Example.txt");

        [SolutionMethod(Part = 2)]
        public long SolvePart2() => MultiplyBasins("Day09/Input.txt");
