...
namespace Solutions
{
    ...
    public class Day15Solution
    {
        ...
        public long SolveExample1() => CountShortestPath("Day15/Example.txt", 1);

        [SolutionMethod(Part = 1)]
        public long SolvePart1() => CountShortestPath("Day15/Input.txt", 1);

        public long SolveExample2() => CountShortestPath("Day15/Example.txt", 5);

        [SolutionMethod(Part = 2)]
        public long SolvePart2() => CountShortestPath("Day15/Input.txt", 5);
