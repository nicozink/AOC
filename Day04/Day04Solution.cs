...
namespace Solutions
{
    ...
    public class Day04Solution
    {
        ...
        public int SolveExample1() => GetWinningScore("Day04/Example.txt");

        [SolutionMethod(Part = 1)]
        public int SolvePart1() => GetWinningScore("Day04/Input.txt");

        public int SolveExample2() => GetLastWinningScore("Day04/Example.txt");

        [SolutionMethod(Part = 2)]
        public int SolvePart2() => GetLastWinningScore("Day04/Input.txt");
